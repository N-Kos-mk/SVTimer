...
function setTimerPre(target, timerProperty) {
  ...
  function changeSelect() {
    ...
    document.getElementById("timer2 .timer_date").innerHTML = nowdata.date;
  ...
  function configureAdd() {
    ...
    if (configure) {
      ...
      base.querySelector(".addDate input").forEach((element) => element.value = "");
      base.querySelectorAll(".addSec input").value = "";
  ...
  window.onload = function () {
    ...
    addNumericInput(document.querySelector(".base .addSec input"));
    var inputs = document.querySelector(".base .addDate").querySelectorAll("input");
